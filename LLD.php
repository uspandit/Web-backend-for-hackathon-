...
textarea:focus,input:focus{
  ...
  <img src="https://th.bing.com/th/id/R.e81fb7b6cfa72b79f1dec70f2ba07f41?rik=eIm%2fRTMNNjhdtg&riu=http%3a%2f%2fsvkm.phemesoft.com%2fpluginfile.php%2f1%2ftheme_croplms%2flogo%2f1578155163%2fIBM+ICE+program+logo_1.jpg&ehk=rjRhgz3kbgFC%2bqV2XXToRIaXXCyaypK6sDcihn3h%2fog%3d&risl=&pid=ImgRaw&r=0" alt="IBM LOGO" class="center">
   ...
   <div class="testbox">
      <form method="post" action="LLDstore.php" enctype="multipart/form-data">
        
      <div class="heading">
        <h1 style=color:#ffffff>LLD SUBMISSION</h1>
      </div>
        ...
        <div class="colums">
          ...
          <div class="item">
            ...
            <input id="Team Name" type="text"   name="TeamName" required/>
          </div>
         
          <div class="item">
            <label for="LLD">LLD<span>*</span></label>
            <input id="LLD" type="file"   name="LLDfile" accept='file/pdf'  required/>
          </div>
